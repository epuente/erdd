...
System.out.println("............  cero");    		
    		return ok ( views.html.Evaluaciones.evaluada.render(Recursoevaluador.find.where().eq("recurso.id", idRe).findList(), idAspecto )  );
    	} else {
System.out.println("............  NO cero");    		
			List<Recursoevaluador> aux = Recursoevaluador.find.where().eq("id",idRe).findList();
    		return ok ( views.html.Evaluaciones.evaluada.render(aux, idAspecto)  );
    	}
    }
    ...
    public static Result evaluadas(Long idRecurso, String tipo){
		...
		return ok ( views.html.Evaluaciones.evaluada.render( r.recursoevaluadores, tipo)  );
    }    
