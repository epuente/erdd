...
CREATE TRIGGER clasificador_catalogo_criterio3_BEFORE_INSERT BEFORE INSERT ON clasificador_catalogo_criterio3 FOR EACH ROW BEGIN  if (new.auditinsert is null) then     set new.auditinsert = current_timestamp();   end if; END;;
...
CREATE TRIGGER clasificador_criterio3ejemplo_BEFORE_INSERT BEFORE INSERT ON clasificador_criterio3ejemplo FOR EACH ROW BEGIN  if (new.auditinsert is null) then     set new.auditinsert = current_timestamp();   end if; END;;
...
CREATE TRIGGER cobertura_contenido_BEFORE_INSERT BEFORE INSERT ON cobertura_contenido FOR EACH ROW BEGIN  if (new.auditinsert is null) then     set new.auditinsert = current_timestamp();   end if; END;;
...
CREATE TRIGGER director_BEFORE_INSERT BEFORE INSERT ON director FOR EACH ROW BEGIN  if (new.auditinsert is null) then     set new.auditinsert = current_timestamp();   end if; END;;
CREATE TRIGGER director_firma_BEFORE_INSERT BEFORE INSERT ON director_firma FOR EACH ROW BEGIN  if (new.auditinsert is null) then     set new.auditinsert = current_timestamp();   end if; END;;
...
CREATE TRIGGER evaluacion_prorroga_BEFORE_INSERT BEFORE INSERT ON evaluacion_prorroga FOR EACH ROW BEGIN  if (new.auditinsert is null) then     set new.auditinsert = current_timestamp();   end if; END;;
...
CREATE TRIGGER evaluacion_tabla_tipo_recurso_BEFORE_INSERT BEFORE INSERT ON evaluacion_tabla_tipo_recurso FOR EACH ROW BEGIN  if (new.auditinsert is null) then     set new.auditinsert = current_timestamp();   end if; END;;
...
CREATE TRIGGER evaluador_firma_BEFORE_INSERT BEFORE INSERT ON evaluador_firma FOR EACH ROW BEGIN  if (new.auditinsert is null) then     set new.auditinsert = current_timestamp();   end if; END;;
...
CREATE TRIGGER oficiovaloracion_formato_BEFORE_INSERT BEFORE INSERT ON oficiovaloracion_formato FOR EACH ROW BEGIN  if (new.auditinsert is null) then     set new.auditinsert = current_timestamp();   end if; END;;
CREATE TRIGGER oficiovaloracion_formato_logo_BEFORE_INSERT BEFORE INSERT ON oficiovaloracion_formato_logo FOR EACH ROW BEGIN  if (new.auditinsert is null) then     set new.auditinsert = current_timestamp();   end if; END;;
...
CREATE TRIGGER play_evolutions_BEFORE_INSERT BEFORE INSERT ON play_evolutions FOR EACH ROW BEGIN  if (new.auditinsert is null) then     set new.auditinsert = current_timestamp();   end if; END;;
...
CREATE TRIGGER recurso_calificacion_BEFORE_INSERT BEFORE INSERT ON recurso_calificacion FOR EACH ROW BEGIN  if (new.auditinsert is null) then     set new.auditinsert = current_timestamp();   end if; END;;
CREATE TRIGGER recurso_calificacion_a_BEFORE_INSERT BEFORE INSERT ON recurso_calificacion_a FOR EACH ROW BEGIN  if (new.auditinsert is null) then     set new.auditinsert = current_timestamp();   end if; END;;
...
CREATE TRIGGER reporte_logo_BEFORE_INSERT BEFORE INSERT ON reporte_logo FOR EACH ROW BEGIN  if (new.auditinsert is null) then     set new.auditinsert = current_timestamp();   end if; END;;
...
CREATE TRIGGER unidad_medida_BEFORE_INSERT BEFORE INSERT ON unidad_medida FOR EACH ROW BEGIN  if (new.auditinsert is null) then     set new.auditinsert = current_timestamp();   end if; END;;
...
CREATE TRIGGER unidadacademica_areaconocimiento_BEFORE_INSERT BEFORE INSERT ON unidadacademica_areaconocimiento FOR EACH ROW BEGIN  if (new.auditinsert is null) then     set new.auditinsert = current_timestamp();   end if; END;;
CREATE TRIGGER unidadacademica_director_BEFORE_INSERT BEFORE INSERT ON unidadacademica_director FOR EACH ROW BEGIN  if (new.auditinsert is null) then     set new.auditinsert = current_timestamp();   end if; END;;
CREATE TRIGGER unidadacademica_niveleducativo_BEFORE_INSERT BEFORE INSERT ON unidadacademica_niveleducativo FOR EACH ROW BEGIN  if (new.auditinsert is null) then     set new.auditinsert = current_timestamp();   end if; END;;
...
CREATE TRIGGER clasificador_catalogo_criterio3_BEFORE_UPDATE BEFORE UPDATE ON clasificador_catalogo_criterio3 FOR EACH ROW BEGIN  set new.auditlastupdate = current_timestamp(); END;;
...
CREATE TRIGGER clasificador_criterio3ejemplo_BEFORE_UPDATE BEFORE UPDATE ON clasificador_criterio3ejemplo FOR EACH ROW BEGIN  set new.auditlastupdate = current_timestamp(); END;;
...
CREATE TRIGGER cobertura_contenido_BEFORE_UPDATE BEFORE UPDATE ON cobertura_contenido FOR EACH ROW BEGIN  set new.auditlastupdate = current_timestamp(); END;;
...
CREATE TRIGGER director_BEFORE_UPDATE BEFORE UPDATE ON director FOR EACH ROW BEGIN  set new.auditlastupdate = current_timestamp(); END;;
CREATE TRIGGER director_firma_BEFORE_UPDATE BEFORE UPDATE ON director_firma FOR EACH ROW BEGIN  set new.auditlastupdate = current_timestamp(); END;;
...
CREATE TRIGGER evaluacion_prorroga_BEFORE_UPDATE BEFORE UPDATE ON evaluacion_prorroga FOR EACH ROW BEGIN  set new.auditlastupdate = current_timestamp(); END;;
...
CREATE TRIGGER evaluacion_tabla_tipo_recurso_BEFORE_UPDATE BEFORE UPDATE ON evaluacion_tabla_tipo_recurso FOR EACH ROW BEGIN  set new.auditlastupdate = current_timestamp(); END;;
...
CREATE TRIGGER evaluador_firma_BEFORE_UPDATE BEFORE UPDATE ON evaluador_firma FOR EACH ROW BEGIN  set new.auditlastupdate = current_timestamp(); END;;
...
CREATE TRIGGER oficiovaloracion_formato_BEFORE_UPDATE BEFORE UPDATE ON oficiovaloracion_formato FOR EACH ROW BEGIN  set new.auditlastupdate = current_timestamp(); END;;
CREATE TRIGGER oficiovaloracion_formato_logo_BEFORE_UPDATE BEFORE UPDATE ON oficiovaloracion_formato_logo FOR EACH ROW BEGIN  set new.auditlastupdate = current_timestamp(); END;;
...
CREATE TRIGGER play_evolutions_BEFORE_UPDATE BEFORE UPDATE ON play_evolutions FOR EACH ROW BEGIN  set new.auditlastupdate = current_timestamp(); END;;
CREATE TRIGGER recurso_BEFORE_UPDATE BEFORE UPDATE ON recurso FOR EACH ROW BEGIN  set new.auditlastupdate = current_timestamp(); END;;
...
CREATE TRIGGER recurso_calificacion_BEFORE_UPDATE BEFORE UPDATE ON recurso_calificacion FOR EACH ROW BEGIN  set new.auditlastupdate = current_timestamp(); END;;
CREATE TRIGGER recurso_calificacion_a_BEFORE_UPDATE BEFORE UPDATE ON recurso_calificacion_a FOR EACH ROW BEGIN  set new.auditlastupdate = current_timestamp(); END;;
...
CREATE TRIGGER reporte_logo_BEFORE_UPDATE BEFORE UPDATE ON reporte_logo FOR EACH ROW BEGIN  set new.auditlastupdate = current_timestamp(); END;;
...
CREATE TRIGGER unidad_medida_BEFORE_UPDATE BEFORE UPDATE ON unidad_medida FOR EACH ROW BEGIN  set new.auditlastupdate = current_timestamp(); END;;
...
CREATE TRIGGER unidadacademica_areaconocimiento_BEFORE_UPDATE BEFORE UPDATE ON unidadacademica_areaconocimiento FOR EACH ROW BEGIN  set new.auditlastupdate = current_timestamp(); END;;
CREATE TRIGGER unidadacademica_director_BEFORE_UPDATE BEFORE UPDATE ON unidadacademica_director FOR EACH ROW BEGIN  set new.auditlastupdate = current_timestamp(); END;;
CREATE TRIGGER unidadacademica_niveleducativo_BEFORE_UPDATE BEFORE UPDATE ON unidadacademica_niveleducativo FOR EACH ROW BEGIN  set new.auditlastupdate = current_timestamp(); END;;
