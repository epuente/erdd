...
/**/
object ctaCoordEdit extends BaseScalaTemplate[play.twirl.api.HtmlFormat.Appendable,Format[play.twirl.api.HtmlFormat.Appendable]](play.twirl.api.HtmlFormat) with play.twirl.api.Template1[Form[Personal],play.twirl.api.HtmlFormat.Appendable] {
	...
	"""),format.raw/*8.2*/("""<div class=container-fluid style="background-color: white; padding: 10px" >
			<div class="row">
				<div class="col-lg-12">
					<ol class="breadcrumb">
					  <li>Catálogos</li>
					  <li class="active">Coordinador de ERDD</li>
					</ol>			
				</div>
			</div>
			<div class="row">
				<div class="col-lg-12">
	  	          <h3>Coordinador del proceso de ERDD</h3>
		        </div>
			</div>    
		    ...
		    """)))}),format.raw/*27.8*/("""
			    ...
			    """),_display_(/*30.9*/form(CSRF(routes.PersonalController.CoordUpdate()))/*30.60*/ {_display_(Seq[Any](format.raw/*30.62*/("""
...
"""))}
  ...
  def ref: this.type = this
              ...
              /*
                  ...
                  SOURCE: /home/epuente/playFramework/erdd2024/app/views/ctaCoordEdit.scala.html
                  HASH: 2d9a41eea7576137f2465ddad47765716e611b2d
